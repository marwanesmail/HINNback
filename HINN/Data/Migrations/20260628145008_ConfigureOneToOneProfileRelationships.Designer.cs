...
namespace HINN.Data.Migrations
{
    ...
    [Migration("20260628145008_ConfigureOneToOneProfileRelationships")]
    partial class ConfigureOneToOneProfileRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyHealthcareApi.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyHealthcareApi.Models.Company", b =>
                {
                    b.HasOne("MyHealthcareApi.Models.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("MyHealthcareApi.Models.Company", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyHealthcareApi.Models.Doctor", b =>
                {
                    b.HasOne("MyHealthcareApi.Models.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("MyHealthcareApi.Models.Doctor", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyHealthcareApi.Models.Patient", b =>
                {
                    b.HasOne("MyHealthcareApi.Models.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("MyHealthcareApi.Models.Patient", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyHealthcareApi.Models.Pharmacy", b =>
                {
                    b.HasOne("MyHealthcareApi.Models.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("MyHealthcareApi.Models.Pharmacy", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
